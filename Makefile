# This Makefile is for the File::Content extension to perl.
#
...
AR_STATIC_ARGS = cr
NAME = File::Content
DISTNAME = File-Content
NAME_SYM = File_Content
VERSION = 0.01
VERSION_SYM = 0_01
XS_VERSION = 0.01
INST_BIN = blib/bin
...
TO_INST_PM = Content.pm

PM_TO_BLIB = Content.pm \
	$(INST_LIBDIR)/Content.pm
...
manifypods : pure_all Content.pm
	@$(POD2MAN) \
	Content.pm \
	$(INST_MAN3DIR)/File::Content.$(MAN3EXT)
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"File-Content\" VERSION=\"0,01,0,0\">\n}. qq{\t<TITLE>File-Content</TITLE>\n}. qq{\t<ABSTRACT></ABSTRACT>\n}. qq{\t<AUTHOR></AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"i686-linux\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > File-Content.ppd
